...
func TestCorrelateDecodedRingbufSampleUsesMonotonicRestartGap(t *testing.T) {
	...
	raw := buildRingbufSample(1, eventMonotonic, 7000, 6999, 7000, 500, "bash")
...
func buildRingbufSample(rawType uint8, monotonicNS uint64, pid, ppid, tid uint32, cgroupID uint64, comm string) []byte {
